    ...
    <div className="px-10 md:px-28 lg:px-20 mt-10">
      <div className="flex-col">
        <div className="mb-20 flex flex-col lg:flex-row gap-10 text-slate-500">
          ...
          <div className="flex flex-col gap-2 basis-1/4">
            ...
            <p>
              ...
              to make learning easy for both tutor and learnr by equiping them
              with a tool that powers the learning process
            </p>
            <p>
              Our learning platform has an integrated video conferencing
              software and also lets you quickly create a lesson , let learners
              enroll and pay if its premium and then schedule a meeting with the
              learners{" "}
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex-col">
            <h2 className="font-extrabold text-primary mb-3 text-[40px]">
        ...
        <div className=" mt-10 flex flex-col gap-3 sm:flex-row">
          <div className="h-[400px] border-2 border-primary flex-1 rounded-xl mb-10 p-5 shadow-md">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="flex flex-row items-center gap-3 text-gray-700">
                <UserRoundCog color="#e67e22" aria-checked /> Manage your
                learners ....
              </p>
              <p className="flex flex-row items-center gap-3 text-gray-700">
